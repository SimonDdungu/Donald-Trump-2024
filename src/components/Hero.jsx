    ...
    return <section className="Hero_section">
                <div className="Hero_page">
                    ...
                    <div className="Hero_Content">
                        <h1 className='anton-sc-regular'><span className="blue_text">America </span><span className="red_text">Triumphant</span>: Celebrating President Donald J. Trump's 2024 Victory!</h1>
                        <p>Join us in honoring a historic victory! Together, we've made our voices heard, reigniting the American spirit 
                            and paving the way for renewed strength, prosperity, and freedom. 
                        ...
                        <br />it's a new chapter for America. 
                        </p>
